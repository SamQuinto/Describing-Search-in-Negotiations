...
export const demoScoresheet = {
  "Pets_Allowed": [
    { option: "Yes", score: 12, reason: "**Personal Life at Home:** You have a cat you're bringing, so the apartment needs to work for your everyday life." },
    { option: "No", score: 0, reason: "" }
  ],
  "Overnight_Guests": [
    { option: "Yes", score: 10, reason: "**Personal Life at Home:** Your partner visits often on weekends, so overnight guests matter to you." },
    { option: "No", score: 0, reason: "" }
  ],
  "Kitchen_Storage": [
    { option: "Yes", score: 8, reason: "**Shared Kitchen Use:** More kitchen storage makes it easier to cook and use the kitchen together." },
    { option: "No", score: 0, reason: "" }
  ],
  "Shared_Groceries": [
    { option: "Yes", score: -9, reason: "**Shared Kitchen Use:** You prefer to buy your own food and keep groceries separate." },
    { option: "No", score: 0, reason: "" }
  ],
  "Clean_Ourselves": [
    { option: "Yes", score: 0, reason: "**Household Chores and Comfort:** You are flexible on this." },
    { option: "No", score: 0, reason: "" }
  ],
  "Cooler_Winter_Temp": [
    { option: "Yes", score: -7, reason: "**Household Chores and Comfort:** You prefer warmer temperatures and don't want the apartment kept too cold in winter." },
    { option: "No", score: 0, reason: "" }
  ],
  "Late_Nights_OK": [
    { option: "Yes", score: -5, reason: "**Quiet and Common Space:** You prefer quiet evenings and don't want late nights to disrupt the apartment." },
    { option: "No", score: 0, reason: "" }
  ],
  "Living_Room": [
    { option: "Yes", score: -11, reason: "**Quiet and Common Space:** You have strong preferences against this living room setup." },
    { option: "No", score: 0, reason: "" }
  ]
};